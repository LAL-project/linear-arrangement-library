...
public:
	...
	[[nodiscard]] sorted_vector& operator= (const sorted_vector& v
	) noexcept = default;
	/// Move-assignment operator
	[[nodiscard]] sorted_vector& operator= (sorted_vector&& v
	) noexcept = default;
