...
operator""_root_free_tree (const char *str, const std::size_t s) noexcept;
...
operator""_free_tree (const char *str, const std::size_t s) noexcept;
...
operator""_rooted_tree (const char *str, const std::size_t s) noexcept;
