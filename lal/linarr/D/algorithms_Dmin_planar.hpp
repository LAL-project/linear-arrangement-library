...
// algorithms_Dmin_planar.py python file.

/**
 * @brief The different algorithms for computing the minimum sum of the
 * length of the edges \f$D\f$ in planar arrangements of free trees.
 *
 * Recall that a planar arrangement is one in which there are no edge
 * crossings.
 *
 * This enumeration's values are used to choose the algorithm which the functions
 * @ref lal::linarr::min_sum_edge_lengths_planar use to compute the minimum
 * value of the sum of the length of the edges \f$D\f$.
 */
enum class algorithms_Dmin_planar {
	/**
