...
inline
rational __get_approximate_C_2_rational(const undirected_graph& g, const linear_arrangement& pi) {
	rational Ec2(0);
...
rational approximate_C_rational(const undirected_graph& g, const linear_arrangement& pi) {
