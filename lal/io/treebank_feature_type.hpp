 ...
 */
enum class treebank_feature_type {
	...
	/**
	 * @brief Minimum sum of length of edges over bipartite arrangements.
	 *
	 * See @ref lal::linarr::min_sum_edge_lengths_bipartite for details.
	 */
