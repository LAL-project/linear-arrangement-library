 ...
 * - Edge list. See functions @ref read_edge_list(const std::string&, graphs::undirected_graph&, bool)
 * and @ref read_edge_list(const std::string&, graphs::directed_graph&, bool).
 * 
