...
# In this piece of code we modify class "treebank_processor".
# Remember: "treebank_processor" is the automatic processing
# of a dataset.
#
...
# As created by SWIG, class "treebank_processor" has attributes of the
# form:
# 		treebank_processor.processor_error_none
# 		treebank_processor.processor_error_missing_parent
# 		treebank_processor.processor_error_missing_main
# 		....
# and also
# 		treebank_processor.tree_feature_n
...
# 		treebank_processor.processor_error.none
# 		treebank_processor.processor_error.missing_parent
# 		treebank_processor.processor_error.missing_main
# 		....
# and also
# 		treebank_processor.tree_feature.n
# 		treebank_processor.tree_feature.k2
...
for enval_name in prerr_enum_vals:
	...
	# delete enumeration value from "treebank_processor"
...
# attributes of class "treebank_processor"
